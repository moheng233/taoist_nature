...
public class Lingshi extends Item {
    ...
    @Override
    public  void appendStacks(net.minecraft.item.ItemGroup group, net.minecraft.util.DefaultedList<net.minecraft.item.ItemStack> stacks) {
    ...
    public Text getName(ItemStack itemStack) {
        ...
        return new TranslatableText("item.legal_logic.lingshi",new TranslatableText("item.legal_logic.lingshi.quality-"+quality));
    }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext){
        ...
        tooltip.add(
            new TranslatableText("item.legal_logic.lingshi.tooltip-1", 
                new TranslatableText("item.legal_logic.lingshi.quality-"+quality)));

        tooltip.add(new TranslatableText("item.legal_logic.lingshi.tooltip-2", integrity));
