...
public class Lingshi extends Item {
    ...
    public Text getName(ItemStack itemStack) {
        ...
        return new TranslatableText("item.taoist_nature.lingshi",
                new TranslatableText("item.taoist_nature.lingshi.quality-" + quality));
    }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        tooltip.add(new TranslatableText("item.taoist_nature.lingshi.tooltip-1",
                new TranslatableText("item.taoist_nature.lingshi.quality-" + quality)));
